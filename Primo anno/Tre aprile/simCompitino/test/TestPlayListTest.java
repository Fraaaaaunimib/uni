...
public class TestPlayListTest {
	...
	public void testContiene(){
		...
		assertTrue(pl.contiene(new Brano("Unchained Melody", 4)));
		
		assertTrue(pl.contiene(new Brano("Wonderful Tonight", 10)));
		
		assertFalse(pl.contiene(new Brano("Are You Lonesome Tonight?", 10)));
	}
	
	public void testPosizioneBrano() {
		PlayList pl = new PlayList("Love songs", 20);
		pl.aggiungiBrano("Unchained Melody", 4);
		pl.aggiungiBrano("Wonderful Tonight", 10);
		pl.aggiungiBrano("Are You Lonesome Tonight?", 10);
		pl.aggiungiBrano(new Brano("All You Need Is Love", 7));
		
		assertTrue(pl.posizioneBrano(new Brano("All You Need Is Love", 7)) == 3);
		assertTrue(pl.posizioneBrano(new Brano("Unchained Melody", 4)) == 0);
		assertTrue(pl.posizioneBrano(null) == -1);	
	}
